        ...
        implements ActionListener, PropertyChangeListener
{
  ...
  private Box box1;
  private ResourceBundle TabsizeDialogResources;
  private final static String resourceSrc = "resources/TabsizeDialogResources";


// Constructors
  public TabsizeDialog(JFrame owner, boolean modal, int formerSelection)
  {
    this(owner, owner.getTitle(), modal, formerSelection);
  }

  public TabsizeDialog(JFrame owner, String title, boolean modal,
          int formerSelection)
  {
    ...
    TabsizeDialogResources = HelperClass.getResourceBundleFromJar(resourceSrc, "UTF-8");
...
// End of Constructors
  ...
  {
    dialogPane = new JOptionPane(TabsizeDialogResources.getString("Select_Tabsize"),
    ...
    // tabsize textfield
    tsf = new JTextField();
    tsf.setDocument(new LengthLimitedDocument(2));
